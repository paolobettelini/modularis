...
#[derive(Debug, Clone)]
pub(crate) struct ParkourInstanceRecord {
    pub(crate) id: u64,
    pub(crate) scope: ScopeNodeId,
    players: usize,
}

#[derive(Debug, Clone)]
pub(crate) struct PlayerArenaRecord {
...
#[derive(Resource)]
pub(crate) struct TheCrownRuntime {
    root: Option<ScopeNodeId>,
    pub(crate) instances: Vec<ParkourInstanceRecord>,
    pub(crate) players: HashMap<PlayerId, PlayerArenaRecord>,
...
pub(crate) fn assign_joined_players(
    mut commands: Commands,
    scopes: Res<ServerScopes>,
...
pub(crate) fn welcome_ready_players(
...
pub(crate) fn cleanup_left_players(
    mut commands: Commands,
    scopes: Res<ServerScopes>,
    scope_worlds: Res<ServerScopeWorlds>,
    world: Res<ServerChunkWorld>,
