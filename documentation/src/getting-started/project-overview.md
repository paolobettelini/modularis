...
| `server-core.toml` | Minimal process, transport, session, lifecycle, and cleanup core |
| `server-base.toml` | Convenience umbrella adding neutral optional feature pipelines |
...
- hierarchical runtime scopes with independent chat, world, and visibility
  facets;
